...
def get_data_params():
    ...
    parser.add_argument("--dataset_name", type=str, default='BA_3Motifs_7class_423', help="dataset name string")   #BA_4Motifs, PROTEINS, Tox21, PubMed, NCI1, citeseer, BA_shapes  BA_community   Mutagenicity  Graph_Twitter, Graph-SST2
    parser.add_argument("--dataset_dir", type=str, default='/mnt/8T/torch_projects/datasets/', help="dataset dir string")  
