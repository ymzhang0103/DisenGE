...
def get_dataset(data_args):
    sync_dataset_dict = {
        ...
        'BA_LRP'.lower(): "ba_lrp",
        'BA_4Motifs'.lower(): "BA_4Motifs",
        'BA_6Motifs_2class'.lower(): 'BA_6Motifs_2class',
        'BA_6Motifs_2class_random_withedgelabel'.lower(): 'BA_6Motifs_2class_random_withedgelabel',
        'BA_6Motifs_2class_withedgelabel'.lower(): 'BA_6Motifs_2class_withedgelabel',
        'BA_6Motifs_2class_withedgelabel_ba100'.lower(): 'ba_6motifs_2class_withedgelabel_ba100',
        'BA_6Motifs_2class_withedgelabel_ba50'.lower(): 'ba_6motifs_2class_withedgelabel_ba50',
        'BA_3Motifs_4class'.lower(): 'ba_3motifs_4class',
        'BA_3Motifs_7class'.lower(): 'ba_3motifs_7class',
        'BA_3Motifs_7class_423'.lower(): 'ba_3motifs_7class_423'
    }
    sentigraph_names = ['Graph-SST2', 'Graph_SST5', 'Graph_Twitter']
    ...
    elif data_args.dataset_name.lower() == "pubmed":
        return Planetoid(root=data_args.dataset_dir, name=data_args.dataset_name)
    elif data_args.dataset_name.lower() == "tox21":
        return MoleculeNet(root=data_args.dataset_dir, name=data_args.dataset_name)
    elif data_args.dataset_name.lower() == "proteins":
        tudataset_data = TUDataset(root=data_args.dataset_dir, name=data_args.dataset_name)
        return tudataset_data
    else:
...
class SynGraphDataset(InMemoryDataset):
    ...
    def process(self):
        # Read data into huge `Data` list.
        if self.name == "BA_4Motifs" or  self.name == "BA_6Motifs_2class" or  self.name == "BA_3Motifs_4class" or  self.name == "BA_3Motifs_7class" or  self.name == "BA_3Motifs_7class_423" or self.name == "BA_6Motifs_2class_withedgelabel" or self.name == "BA_6Motifs_2class_random_withedgelabel" or self.name == "BA_6Motifs_2class_withedgelabel_ba100" or self.name == "BA_6Motifs_2class_withedgelabel_ba50":
            with open(os.path.join(self.raw_dir, f"{self.name}.pkl"), 'rb') as f:
                data = pickle.load(f)
