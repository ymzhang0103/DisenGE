...
import torch
from codes.GNNmodels import GnnNets, GnnNets_NC
from codes.fornode.models import GCN2 as GCN
from collections import OrderedDict

def load_gnnNets_NC_cuda92(ckpt_path, input_dim, output_dim, device):
...
load_gnnNets_NC(input_dim, output_dim, dataset_name)
'''