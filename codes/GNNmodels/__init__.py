...
from .GCN import GCNNet, GCNNet_NC
from .GAT import GATNet, GATNet_NC
from .GIN import GINNet, GINNet_NC
...
class GnnNets(GnnBase):
    ...
    def forward(self, data):
        ...
        #logits, prob, emb = self.model(data)
        #return logits, prob, emb
        logits, prob, g_emb, emb = self.model(data)
        return logits, prob, g_emb, emb
